...
const OurStory = () => {
  ...
  useEffect(() => {
    ...
    // Prevent loading BBB script multiple times
    const existingBBBScript = document.querySelector(
      'script[data-bbb-script="true"]'
    );

    if (existingBBBScript) {
      return;
    }

    // Create BBB script
    const bbbScript = document.createElement("script");
    ...
    bbbScript.src =
      scheme +
      "seal-dallas.bbb.org/badge/badge.min.js";

    bbbScript.setAttribute(
      "data-bbb-script",
      "true"
    );

    // Same insertion approach as BBB's original snippet
    const firstScript =
